    ...
    return (
        <div className="w-full h-full relative overflow-hidden bg-white flex flex-col">
            ...
            <div className="flex items-center justify-between p-4 z-10 bg-white">
                <DraggableElement id="headline" className="flex items-center gap-3">
                    <div
                    ...
                    <div className="flex flex-col">
                        <EditableText
                            ...
                            className="text-sm font-bold text-gray-900 leading-tight min-w-[50px]"
                        ...
                        <EditableText
                            ...
                            value={footer}
                            onChange={setFooter}
                            className="text-xs text-gray-500 min-w-[50px]"
            ...
            <div className="px-4 pb-4 bg-white z-10">
                ...
                <div className="text-sm text-gray-900 flex flex-wrap gap-1">
                    <EditableText
                        ...
                        value={headline}
                        onChange={setHeadline}
                        className="font-bold mr-2 min-w-[20px]"
                        placeholder="Username"
                    />
                    <EditableText
                        tagName="span"
                ...
                {(brandingLine1 || brandingLine2) && (
                    <DraggableElement id="footer" className="mt-3">
                        <div style={{ color: primaryColor }} className="text-[10px] font-bold uppercase tracking-widest opacity-60">
                            {brandingLine1} {brandingLine2}
                        </div>
                    </DraggableElement>
                )}
