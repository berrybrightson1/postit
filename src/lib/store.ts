...
const initialState = {
    ...
    headline: DEFAULT_CONTENT.BreakingNews.headline,
    body: DEFAULT_CONTENT.BreakingNews.body,
    footer: DEFAULT_CONTENT.BreakingNews.footer,
    email: DEFAULT_CONTENT.BreakingNews.email,
    ...defaultStyles.BreakingNews,
    mainImage: null,
    logo: null,
    profileImage: null,
    brandingLine1: DEFAULT_CONTENT.BreakingNews.brandingLine1,
    brandingLine2: DEFAULT_CONTENT.BreakingNews.brandingLine2,
    showWatermark: true,
